...
<body>
    ...
    <div class="title">
        <a href="dashboard.php"><img src="./images/logo1.png" height="50%" width="50%" alt="" class="logo"></a>
        <span class="heading" style="color: green;">Dashboard</span>
        <a href="logout.php" style="color: red"><span class="fa fa-sign-out fa-2x">Logout</span></a>
    </div>
